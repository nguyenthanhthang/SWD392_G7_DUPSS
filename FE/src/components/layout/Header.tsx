...
function Header() {
  ...
  const avatarUrl = user?.photoUrl || 'https://ui-avatars.com/api/?name=User&background=eee&color=555';
          ...
          {user ? (
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                />
                <span className="hidden md:inline font-medium text-gray-800 text-lg">{user.username || user.fullName || 'User'}</span>
