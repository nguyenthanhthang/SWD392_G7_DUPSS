...
export default function Home() {
  ...
  const maxConsultantSlider = Math.max(
    0,
    consultants.length - visibleConsultant
  );
          ...
          <div className="mx-auto w-full sm:py-4 px-0 lg:px-0">
            ...
            <div className="relative w-full flex items-center">
              ...
              <button
                ...
                onClick={() =>
                  setConsultantSliderIndex((i) => Math.max(i - 1, 0))
                }
                ...
                <div
                  ...
                  style={{
                    transform: `translateX(-${
                      consultantSliderIndex * (100 / visibleConsultant)
                    }%)`,
                  }}
                >
                  {loadingConsultant ? (
                    <div className="text-center w-full py-20 text-xl">
                      Đang tải chuyên gia...
                    </div>
                  ) : errorConsultant ? (
                    <div className="text-center w-full py-20 text-red-600 text-xl">
                      {errorConsultant}
                    </div>
                  ) : consultants.length === 0 ? (
                    <div className="text-center w-full py-20 text-gray-500 text-xl">
                    ...
                    consultants.map((consultant, idx) =>
                      consultant.accountId ? (
                        ...
                        >
                          <div className="relative flex flex-col items-center">
                            <img
                              ...
                              width={200}
                              height={200}
                              className="inline-block m-auto rounded-full mb-4"
                            />
                          </div>
                          <h4 className="text-3xl font-bold pt-6">
                            {consultant.accountId.fullName || "Chuyên gia"}
                          </h4>
                          <h3 className="text-xl font-normal pt-2 pb-2 opacity-50">
                            Chuyên gia tư vấn
                          </h3>
                          <div className="text-gray-600 text-center mb-2 line-clamp-2">
                            {consultant.introduction}
                          </div>
                          <div className="text-gray-400 text-sm mb-4">
                            Liên hệ:{" "}
                            {consultant.accountId.phoneNumber ||
                          ...
                          <motion.button
                            ...
                            onClick={() =>
                              (window.location.href = `/consultant/${consultant._id}`)
                            }
                          >
                            Đặt lịch
                          </motion.button>
                        ...
                        <div
                          key={consultant._id}
                          className="bg-red-100 rounded-3xl shadow-lg p-6 flex flex-col items-center"
                        >
                          <div className="text-red-600 font-bold">
                            Thiếu thông tin tài khoản cho chuyên gia này
                          </div>
                        </div>
                      )
                    )
              ...
              <button
                ...
                onClick={() =>
                  setConsultantSliderIndex((i) =>
                    Math.min(i + 1, maxConsultantSlider)
                  )
                }
                disabled={
                  consultantSliderIndex === maxConsultantSlider ||
                  consultants.length === 0
                }
                aria-label="Next"
              >
              ...
              <div className="w-full overflow-hidden px-12">
                ...
                >
                  {postData.map((items, i) => (
                    <div
                      key={i}
                      className="bg-white m-3 px-3 pt-3 pb-12 my-10 shadow-lg rounded-3xl relative min-w-[380px] max-w-[400px] w-[400px] flex-shrink-0"
                    >
                      <img
                        src={items.imgSrc}
                        alt="post"
                      ...
                      <a
                        href="/"
                        className="absolute bg-blue-600 text-white hover:bg-black hover:shadow-xl py-3 px-6 rounded-full article-img left-1/2 -translate-x-1/2 top-40"
                      >
                        {items.time} read
                      </a>
